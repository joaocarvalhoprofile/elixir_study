defmodule Xirfoods.Orders.Item do
  @categories [:pizza, :hamburquer, :carne, :prato_feito, :japonesa, :sobremesa]
  ...
  def build(_descrition, _category, _unity_price, _quantity) do
