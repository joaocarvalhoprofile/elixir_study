defmodule ReportsGeneratorTest do
  ...
  describe "builder/1" do
    test "builds the report" do
      ...
      assert expeted_response == response
    end
  end

  describe "builder_from_many/1" do
    test "When no provide a file list" do
      response = ReportsGenerator.build_from_many("Nothing file list")

      expeted_response = {:error, "Please provide a list of strings"}
  ...
  describe("fetch_higher_cost/2") do
    ...
    test "When the option is 'foods', returns the foods that left the most" do
      file_name = "report_test.csv"
    ...
    test "if invalid options, returns an error" do
      ...
      response =
        file_name
        |> ReportsGenerator.build()
        |> ReportsGenerator.fetch_higher_cost("nothing")
